...
from icloud_mcp.search.vector import VECTOR_DIMENSIONS, VECTOR_MODEL, embedding_vector
from icloud_mcp.search.vector_backend import ensure_vector_backend, upsert_chunk_vector
